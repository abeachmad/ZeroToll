...
echo ""
echo "📊 Services:"
echo "   • Python Backend:    http://localhost:3002  🚀 EIP-7702 ENABLED"
echo "   • Frontend:          http://localhost:3000"
echo ""
echo "🚀 EIP-7702 Endpoints (Type 0x04 Transactions):"
echo "   • Info:    http://localhost:3002/api/eip7702/info"
echo "   • Health:  http://localhost:3002/api/eip7702/health/{chain_id}"
echo "   • Nonce:   http://localhost:3002/api/eip7702/nonce/{chain_id}/{address}"
echo "   • Quote:   POST http://localhost:3002/api/eip7702/quote"
echo "   • Execute: POST http://localhost:3002/api/eip7702/execute"
echo ""
