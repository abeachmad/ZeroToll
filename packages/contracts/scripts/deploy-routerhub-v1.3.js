...
async function main() {
  console.log("Deploying RouterHub v1.3 (intent.user pull + push pattern)...");
  ...
  console.log("\n" + "=".repeat(70));
  console.log("🎉 DEPLOYMENT COMPLETE - RouterHub v1.3");
  console.log("=".repeat(70));
  console.log(`RouterHub: ${routerHubAddress}`);
  console.log(`Adapter v7: ${ADAPTER_V7}`);
  console.log("\n🔑 KEY CHANGE: Now pulls from intent.user, not msg.sender!");
  console.log("   This allows relayer to submit TX on behalf of signed user.");
  console.log("\nNext: Update backend/.env and test with user approval!");
}
