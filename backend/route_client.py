...
class RoutePlannerClient:
    ...
    def _fallback_routing(self, intent: Dict[str, Any]) -> List[RouteCandidate]:
        ...
        # Use deployed MockDEXAdapter addresses
        adapter_addresses = {
            11155111: "0xEE4BeDddFdCfD485AbF3fF5DaE5ab34071338e24",  # FINAL MockDEXAdapter (decimal handling fix)
            80002: "0xc6Dd26D3eE0F58fAb15Dc87bEe3A66896B6D4127",      # RouterHub Amoy (TODO: deploy MockDEX here)
        }
