...
class DEXIntegrationService:
    def __init__(self):
        ...
        self.rpc_urls = {
            80002: [
                os.getenv("RPC_AMOY", "https://rpc-amoy.polygon.technology"),
            ...
            421614: [
                os.getenv("RPC_ARBITRUM_SEPOLIA", "https://sepolia-rollup.arbitrum.io/rpc"),
                "https://arbitrum-sepolia.blockpi.network/v1/rpc/public"
            ],
            11155420: [
                os.getenv("RPC_OPTIMISM_SEPOLIA", "https://sepolia.optimism.io"),
        ...
        self.dex_routers = {
            80002: {
                "router": os.getenv("AMOY_DEX_ROUTER", "0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff"),
                "name": "QuickSwap"
            },
            11155111: {
                "router": os.getenv("SEPOLIA_DEX_ROUTER", "0xC532a74256D3Db42D0Bf7a0400fEFDbad7694008"),
                "name": "Uniswap V2"
            },
            421614: {
                "router": os.getenv("ARB_SEPOLIA_DEX_ROUTER", "0x101F443B4d1b059569D643917553c771E1b9663E"),
                "name": "Uniswap V3"
            },
            11155420: {
                "router": os.getenv("OP_SEPOLIA_DEX_ROUTER", "0x94cC0AaC535CCDB3C01d6787D6413C739ae12bc4"),
                "name": "Uniswap V3"
            }
        }
