...
# Run from project root: ./scripts/deploy-phase2.sh
#
# Prerequisites:
...
echo "   cd bundler-infinitism"
echo "   ./start-bundler.sh"
echo ""
echo "3. Start the self-hosted relayer:"
echo "   node backend/self-hosted-relayer.mjs"
echo ""
echo "4. (Optional) Start gas tank monitor:"
